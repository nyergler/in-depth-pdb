# -*- coding: utf-8 -*-
#
# In Depth PDB documentation build configuration file, created by
# sphinx-quickstart on Sun Jan  6 12:44:14 2013.
#
    ...
    'presenters': [
        {
            'name': 'Nathan Yergler',
            'twitter': '@nyergler',
            'www': 'http://presentotron.com/nyergler/pdb',
...
htmlhelp_basename = 'InDepthPDBdoc'
...
latex_documents = [
  ('index', 'InDepthPDB.tex', u'In Depth PDB Documentation',
...
man_pages = [
    ('index', 'indepthpdb', u'In Depth PDB Documentation',
     [u'Nathan Yergler'], 1)
]
...
texinfo_documents = [
  ('index', 'InDepthPDB', u'In Depth PDB Documentation',
   u'Nathan Yergler', 'InDepthPDB', 'One line description of project.',
   'Miscellaneous'),
]
